...
public class PurchasedPart extends Part implements Serializable
{
	...
	public PurchasedPart() throws InvalidProductionArgumentException
	{
		this(0);
	}
	...
	public PurchasedPart(int id, double hCost, double purPrice, String vend) throws InvalidProductionArgumentException
	{
		this(id, //id for Part object
                DEFAULT_PART_DESCRIPTION, //desc for Part object
	...
	public void setVendor(String newVendor) throws  NullPointerException {
		if (newVendor != null)
			vendor = newVendor;
				...
				throw new NullPointerException("The vendor is null");
	}
